...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${scrolled ? "bg-[#3ead2d] backdrop-blur-md shadow-sm border-b border-slate-100 py-" : "bg-[#2E2DAD] py-4"}`}>
        ...
        <div className="hidden md:flex items-center gap-2 ">
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              ...
              <div className="flex items-center gap-3">
                <Link to="/login" className="bg-blue-600 text-white px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-blue-700 transition-all shadow-md">Login</Link>
                <Link to="/signup" className="bg-blue-600 text-white px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-blue-700 transition-all shadow-md">Join Now</Link>
              </div>
            )}
          </div>
        </div>
